...
import { IoMdAdd, IoMdDoneAll, IoMdEye, IoMdPrint, } from "react-icons/io";
...
const History = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch(`${backendUrl}/api/ticketht/approved/all`, {
      method: 'GET',
      headers: {
                    ...
                    .map((ticket, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          {ticket.created_at ? format(new Date(ticket.created_at), 'yyyy/MM/dd HH:mm') : 'Not yet'}
                        </td>
