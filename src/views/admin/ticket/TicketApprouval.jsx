...
const TicketApproval = () => {
    ...
    useEffect(() => {
        fetch(`${backendUrl}/api/ticket/solved`) 
    ...
    const handleApprouveClick = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await fetch(`${backendUrl}/api/ticket/approved/${selectedTicketIds}`, {
                        method: "PUT",
                        headers: {
    ...
    const handleResetTicket = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await fetch(`${backendUrl}/api/ticket/resetToSolved/${selectedTicketIds}`, {
                        method: "PUT",
                        headers: {
                            "Content-Type": "application/json",
                        },
