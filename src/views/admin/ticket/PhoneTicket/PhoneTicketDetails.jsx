...
const PhoneticketDetails = () => {
    ...
    useEffect(() => {
        if (ticketId) {
            fetch(`${backendUrl}/api/ticket/${ticketId}`)
                ...
                <div  className="text-navy-700 mx-0 mb-2.5 mt-5 text-center font-semibold dark:text-white">
                    ...
                    <div className="min-w-screen dark:bg-navy-900 relative mx-auto my-5 rounded-2xl bg-white p-5 py-10 shadow-[2px_2px_5px_rgba(0,0,0,0.05)]">
                        <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="flex sm:col-span-3">
                                <strong className="text-navy-900 dark:text-white">Solution:</strong>
                                <p className={`ml-2 mb-1 text-${ticketDetails.solution ? "navy-900" : "red-700"} dark:text-gray-200`}>
                                    {ticketDetails.solution ? ticketDetails.solution : "Non rempli"}
                                </p>
                            </div>
                            <div className="flex sm:col-span-3">
                            ...
                            <div className="flex sm:col-span-3">
                                <strong className="text-navy-900 dark:text-white">Creating Time:</strong>
